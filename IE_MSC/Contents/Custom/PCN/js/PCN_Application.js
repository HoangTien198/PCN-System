...
function CreateDatatableCellActionButton(IdApplicaion) {
	return {
		detailButton: `<button type="button" data-id="${IdApplicaion}" onclick="DetailApplication(this, event)" title="Detail" class="btn btn-sm btn-primary"><i class="fa-duotone fa-info"></i></button>`,
		updateButton: `<button type="button" data-id="${IdApplicaion}" onclick="UpdateApplication(this, event)" title="Update" class="btn btn-sm btn-warning"><i class="fa-duotone fa-pen"></i></button>`,
		deleteButton: `<button type="button" data-id="${IdApplicaion}" onclick="DeleteApplication(this, event)" title="Delete" class="btn btn-sm btn-danger"><i class="fa-duotone fa-trash"></i></button>`,
		approvButton: `<button type="button" data-id="${IdApplicaion}" onclick="ApprovApplication(this, event)" title="Approv" class="btn btn-sm btn-success"><i class="fa-duotone fa-check"></i></button>`,
		rejectButton: `<button type="button" data-id="${IdApplicaion}" onclick="RejectApplication(this, event)" title="Reject" class="btn btn-sm btn-danger "><i class="fa-duotone fa-x"></i></button>`,
...
function UpdateApplication(elm, e) {
	let Id = $(elm).data('id');
